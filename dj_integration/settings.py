"""
Django settings for dj_integration project.
...
SECRET_KEY = 'django-insecure-isgbxdb%aw4b20%jx$ifv000knvo)4yp35pa9^_xd+lya$0lk9'
...
ROOT_URLCONF = 'dj_integration.urls'
